...
import com.example.pupilmeshtask.doman_layer.use_case.GetMangaUseCase
...
@HiltViewModel
class MangaViewModel @Inject constructor(private val useCase: GetMangaListUseCase,private val getMangaUseCase: GetMangaUseCase) : ViewModel() {
    ...
    val mangaList = getMangaUseCase().cachedIn(viewModelScope)
//
//    init {
//        fetchManga()
//    }
